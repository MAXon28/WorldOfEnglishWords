...
namespace WorldOfEnglishWord.Adapters
{
    public class FilterHelper : Filter
    {
        ...
        public static FilterHelper NewInstance(List<string> currentRuList, List<string> currentEnList, DictionaryAdapter adapter)
        {
            FilterHelper.currentRuList = currentRuList;
            FilterHelper.currentEnList = currentEnList;
